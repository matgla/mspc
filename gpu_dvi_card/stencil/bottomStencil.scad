// Generated by SolidPython 1.1.3 on 2023-01-20 13:13:41
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.7500000000) {
					offset(r = 1.0000000000) {
						import(file = "/home/mateusz/repos/mspc/gpu_extension/stencil/gpu_extension-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 1.8000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "/home/mateusz/repos/mspc/gpu_extension/stencil/gpu_extension-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
